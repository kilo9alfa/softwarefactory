...
LABELS=(
    ...
    "sf:1-spec|A2EEEF|Spec generated"
    "sf:2-tickets|FBCA04|Tickets broken down"
    "sf:3-plan-review|D4C5F9|Plan generated, awaiting human approval"
    "sf:3-plan-approved|0E8A16|Human approved the plan; ready for dev"
    "sf:4-implemented|5319E7|Code merged; ready for testing"
    "sf:5-ready-for-prod|C2E0C6|Tests pass; awaiting production deploy"
    "sf:6-deployed|1D76DB|Deployed to production"
    "sf:5-needs-debug|B60205|Tests failed; needs debugging"
    "sf:5-test-skipped|D9D9D9|Repo has no .sf.yml test: command; stage 4 could not gate"
    "sf:6-deploy-failed|E11D21|Production deploy failed"
)
