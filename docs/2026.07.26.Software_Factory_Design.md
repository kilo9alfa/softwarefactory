...
│   ├── sf-dispatcher.sh     #   ✅ multi-stage poller (triage, spec, tickets, plan)
...
| — | *(dispatcher)* | `scripts/sf-dispatcher.sh` | — | launches stages 0–3a on their trigger labels; parks at `sf:plan-review` | ✅ Done |
